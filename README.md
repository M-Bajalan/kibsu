...
**It is small enough to actually read.** 5,495 lines across 14 files in `kibsu/`, plus
5,418 lines of tests running 203 cases. That is an evening, not a quarter. Count it
