...
**It is small enough to actually read.** 5,258 lines across 14 files in `kibsu/`, plus
4,833 lines of tests running 181 cases. That is an evening, not a quarter. Count it
