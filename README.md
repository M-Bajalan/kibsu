...
**It is small enough to actually read.** 5,276 lines across 14 files in `kibsu/`, plus
4,877 lines of tests running 182 cases. That is an evening, not a quarter. Count it
