...
**It is small enough to actually read.** 5,812 lines across 14 files in `kibsu/`, plus
5,741 lines of tests running 223 cases. That is an evening, not a quarter. Count it
