...
**It is small enough to actually read.** 5,453 lines across 14 files in `kibsu/`, plus
5,221 lines of tests running 194 cases. That is an evening, not a quarter. Count it
