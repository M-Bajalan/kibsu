...
**It is small enough to actually read.** 5,736 lines across 14 files in `kibsu/`, plus
5,675 lines of tests running 217 cases. That is an evening, not a quarter. Count it
