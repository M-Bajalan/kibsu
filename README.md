...
**It is small enough to actually read.** 5,254 lines across 14 files in `kibsu/`, plus
4,875 lines of tests running 184 cases. That is an evening, not a quarter. Count it
