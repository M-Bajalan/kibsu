...
**It is small enough to actually read.** 5,389 lines across 14 files in `kibsu/`, plus
5,021 lines of tests running 187 cases. That is an evening, not a quarter. Count it
