...
**It is small enough to actually read.** 5,427 lines across 14 files in `kibsu/`, plus
5,120 lines of tests running 192 cases. That is an evening, not a quarter. Count it
