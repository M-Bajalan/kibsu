...
**It is small enough to actually read.** 5,247 lines across 14 files in `kibsu/`, plus
4,820 lines of tests running 180 cases. That is an evening, not a quarter. Count it
