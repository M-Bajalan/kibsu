...
**It is small enough to actually read.** 5,314 lines across 14 files in `kibsu/`, plus
4,976 lines of tests running 187 cases. That is an evening, not a quarter. Count it
