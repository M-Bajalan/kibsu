...
**It is small enough to actually read.** 5,385 lines across 14 files in `kibsu/`, plus
5,065 lines of tests running 190 cases. That is an evening, not a quarter. Count it
