...
**It is small enough to actually read.** 5,871 lines across 14 files in `kibsu/`, plus
5,831 lines of tests running 230 cases. That is an evening, not a quarter. Count it
