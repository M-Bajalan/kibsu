...
**It is small enough to actually read.** 5,347 lines across 14 files in `kibsu/`, plus
4,966 lines of tests running 185 cases. That is an evening, not a quarter. Count it
